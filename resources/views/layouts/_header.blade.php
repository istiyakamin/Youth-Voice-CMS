        ...
        <header class="navbar navbar-fixed-top bg-light">
            ...
            <a class="navbar-brand" href="{{ route('home') }}"> <b>YV</b>CMS
                </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="{{asset('images/profile_picture/'. Auth()->user()->profile_picture)}}" alt="avatar" class="mw30 br64 mr15">
                    ...
                    <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                            ...
                            <span class="pull-right mr10">
                                <select id="user-role">
                                    <optgroup label="Logged in As:">
                                        <option value="1-1">Campus Compas</option>
                                        <option value="1-2">General Member</option>
                                        <option value="1-2">Senior Member</option>
                                        <option value="1-3" selected="selected">Exicutive Body</option>
                                    </optgroup>
                                </select>
                            </span>
                        ...
                        <li class="br-t of-h">
                            <a href="{{ url('/profile').'/'.Auth()->id() }}" class="fw600 p12 animated animated-short fadeInUp">
                        ...
                        <li class="br-t of-h">
                            <a href="{{ url('/logout') }}" class="fw600 p12 animated animated-short fadeInDown" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
